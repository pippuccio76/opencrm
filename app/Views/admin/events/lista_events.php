...
<div class='card'>
        <div class='card-header'>
            <h4>Gestione Events</h4>
        </div>
        <div class='card-body'>

      <div class="row " style="margin-right: 10px; margin-top: 20px;margin-bottom: 20px;">
<div class="col-md text-end">
<a  href="<?=base_url()?>/admin_Events/inserisciRecord" class="btn btn-success" ><i class="fa fa-plus-square "></i>  Crea Events </a>
</div>
</div>
      ...
      <div class="card-title d-flex align-items-center">
        ...
        <h5 class="mb-0 text-primary"> Lista Events</h5>
      </div>
			  ...
			  <?php foreach ($lista as $row): ?>
				...
				<tr>
              	   ...
              	   <td>
              			...
              			<a href='/user_Events/modificaRecord/<?=$row->id?>'  class='btn btn-primary btn-xs'  title='modifica'><i class="fas fa-pencil-alt"></i></a>
              			<a href='/user_Events/eliminaRecord/<?=$row->id?>' alt='elimina' class='btn btn-danger btn-xs' onClick="return confirm('Sei sicuro di voler eliminare il record?');" title='elimina'><i class="fas fa-trash-alt"></i></a>


              		</td>

                    <td> <?= $row->clienti_id()->clienti_id?></td>
