...
$attributes = array('class' => 'col-md-12',
 ...
 echo form_open (base_url() .'/admin_Acquisti/inserisciRecord',$attributes);
...
<div class='col-md-12'>
   ...
   <div class='col-md-12 col-xs-12'>
 <input  type='text'  value='<?=set_value('fattura')?>'  required='required' id='id_class_fattura'  class='form-control' name='fattura' maxlength='(400)/4'  >
   </div>
</div>
</div>
