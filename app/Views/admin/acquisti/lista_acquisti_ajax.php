...
<th class=''>Costo Totale Netto</th>
<th class=''>Costo Totale Lordo</th>
<th class=''>Creato</th>
            ...
            $(document).ready(function() {
				...
				$("#tabella-catalogo").DataTable({
                     'processing': true,
                         ...
                         'ajax': {
                            'url':"<?=base_url('/admin_Acquisti/get_data_from_ajax')?>",
                            'data': function(data){
                               // CSRF Hash
			    ...
			    { data: 'fattura' },
			    { data: 'quantita' },
			    { data: 'costo_totale_netto' },
			    { data: 'costo_totale_lordo' },
			    { data: 'created_at' },
			    { data: 'updated_at' },
			    //{ data: 'deleted_at' },
