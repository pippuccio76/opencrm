...
<a  href="<?=base_url()?>/admin_Clienti/inserisciRecord" class="btn btn-success" ><i class="fa fa-plus-square "></i>  Crea Clienti </a>
</div>
</div>
      ...
      <div class="card-title d-flex align-items-center">
        ...
        <h5 class="mb-0 text-primary"> Lista Clienti</h5>
      </div>
			  ...
			  <?php foreach ($lista as $row): ?>
				...
				<tr>
              	   ...
              	   <td>
              			...
              			<a href='/admin_Clienti/modificaRecord/<?=$row->id?>'  class='btn btn-primary btn-xs'  title='modifica'><i class="fas fa-pencil-alt"></i></a>
              			<a href='/admin_Clienti/eliminaRecord/<?=$row->id?>' alt='elimina' class='btn btn-danger btn-xs' onClick="return confirm('Sei sicuro di voler eliminare il record?');" title='elimina'><i class="fas fa-trash-alt"></i></a>
