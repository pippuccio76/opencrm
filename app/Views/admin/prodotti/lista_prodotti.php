...
<a  href="<?=base_url()?>/admin_Prodotti/inserisciRecord" class="btn btn-success" ><i class="fa fa-plus-square "></i>  Crea Prodotti </a>
</div>
</div>
      ...
      <div class="card-title d-flex align-items-center">
        ...
        <h5 class="mb-0 text-primary"> Lista Prodotti</h5>
      </div>
...
<th class=''>Unita_misura</th>
<th class=''>Scorta_minima</th>
<th class=''>Creato</th>
			  ...
			  <?php foreach ($lista as $row): ?>
				...
				<tr>
              	   ...
              	   <td>
              			...
              			<a href='/user_Prodotti/modificaRecord/<?=$row->id?>'  class='btn btn-primary btn-xs'  title='modifica'><i class="fas fa-pencil-alt"></i></a>
              			<a href='/user_Prodotti/eliminaRecord/<?=$row->id?>' alt='elimina' class='btn btn-danger btn-xs' onClick="return confirm('Sei sicuro di voler eliminare il record?');" title='elimina'><i class="fas fa-trash-alt"></i></a>
