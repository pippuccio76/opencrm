...
<th class=''>Scorta Minima</th>
<th class=''>Iva</th>
<th class=''>Costo Acquisto netto</th>
<th class=''>Costo Acquisto lordo</th>
<th class=''>Costo Vendita netto</th>
<th class=''>Costo Vendita lordo</th>
<th class=''>Creato</th>
            ...
            $(document).ready(function() {
				...
				$("#tabella-catalogo").DataTable({
                     'processing': true,
                         ...
                         'ajax': {
                            'url':"<?=base_url('/admin_Prodotti/get_data_from_ajax')?>",
                            'data': function(data){
                               // CSRF Hash
                         ...
                         'columns': [
                                        ...
                                        { data: 'scorta_minima' },
                                        { data: 'iva' },
                                        { data: 'costo_unitario_acquisto_netto' },
                                        { data: 'costo_unitario_acquisto_lordo' },
                                        { data: 'costo_unitario_vendita_netto' },
                                        { data: 'costo_unitario_vendita_lordo' },
                        			    { data: 'created_at' },
                        			    { data: 'updated_at' },
