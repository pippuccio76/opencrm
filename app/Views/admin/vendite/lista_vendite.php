...
<div class='card'>
        <div class='card-header'>
            <h4>Gestione Vendite</h4>
        </div>
        <div class='card-body'>

      <div class="row " style="margin-right: 10px; margin-top: 20px;margin-bottom: 20px;">
<div class="col-md text-end">
<a  href="<?=base_url()?>/admin_Vendite/inserisciRecord" class="btn btn-success" ><i class="fa fa-plus-square "></i>  Crea Vendite </a>
</div>
</div>
      ...
      <div class="card-title d-flex align-items-center">
        ...
        <h5 class="mb-0 text-primary"> Lista Vendite</h5>
      </div>
...
<th class=''> Clienti</th>
<th class=''> Prodotti</th>
<th class=''>Quantita</th>
<th class=''>Costo_totale_netto</th>
<th class=''>Costo_totale_lordo</th>
<th class=''>Creato</th>
			  ...
			  <?php foreach ($lista as $row): ?>
				...
				<tr>
              	   ...
              	   <td>
              			...
              			<a href='/user_Vendite/modificaRecord/<?=$row->id?>'  class='btn btn-primary btn-xs'  title='modifica'><i class="fas fa-pencil-alt"></i></a>
              			<a href='/user_Vendite/eliminaRecord/<?=$row->id?>' alt='elimina' class='btn btn-danger btn-xs' onClick="return confirm('Sei sicuro di voler eliminare il record?');" title='elimina'><i class="fas fa-trash-alt"></i></a>


              		</td>

                    <td> <?= $row->clienti()->id_clienti?></td>

                    <td> <?= $row->prodotti()->id_prodotti?></td>

                    <td> <?= $row->quantita?></td>

                    <td> <?= $row->costo_totale_netto?></td>

                    <td> <?= $row->costo_totale_lordo?></td>
