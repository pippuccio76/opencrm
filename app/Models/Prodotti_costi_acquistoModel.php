<?php
  ...
  class Prodotti_costi_acquistoModel extends Model {

    protected $table = 'prodotti_costi_acquisto';
    protected $primaryKey = 'id';

    protected $returnType = 'App\Models\Entities\Prodotti_costi_acquisto_Entity';
