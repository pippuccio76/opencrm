...
return [
    ...
    'magicLinkDetails'   => 'Ti abbiamo appena inviato una mail contenente un  link per rigenerare la password. È valido solo per {0} minuti.',
    'magicLinkDisabled'  => 'L\'uso di MagicLink non è permesso.',
    ...
    'errorPasswordTooLongBytes' => ' Password non puo superare {param} caratteri di lunghezza.',
